        ...
        child: FocusTraversalGroup(
          child: BlocBuilder<UiBloc, UiState>(
            builder: (context, uiState) => SizedBox(
              width: uiState.isMenuCollapsed ? 65 : isDesktop(context) ? cDrawerWidthDesktop : cDrawerWidthMobile,
              child: Drawer(
                child: SafeArea(
                  child: Column(
                            ...
                            child: ScrollableListView(
                              children: <Widget>[
                                ...
                                DrawerTile(
                                  ...
                                  title: localization.translate("production orders"),
                                  onTap: () => context.read<UiBloc>().add(ChangeView(ProductionOrdersScreen.route)),
                                  // onLongPress: () => ,
                                ),
                                DrawerTile(
                                  ctx: const ["products"],
                                  icon: Icons.people, // getEntityIcon(EntityType.dashboard),
                                  title: localization.translate("products"),
                                  onTap: () => context.read<UiBloc>().add(ChangeView(const ["products"])),
                                  // onLongPress: () => ,
                                ),
                                DrawerTile(
          ...
          return MyDropdownButton<MemoryItem>(
              ...
              items: [
                ...state.items.map((company) =>
                    DropdownMenuItem<MemoryItem>(
                        value: company,
                        child: ItemWidget(item: company)))
                    .toList(),
              ],
...
class DrawerTile extends StatefulWidget {
  ...
  const DrawerTile({super.key,
    required this.ctx, required this.title, required this.icon,
