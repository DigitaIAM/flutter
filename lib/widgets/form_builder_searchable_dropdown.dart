// copy of https://github.com/flutter-form-builder-ecosystem/form_builder_extra_fields/blob/main/lib/src/fields/form_builder_searchable_dropdown.dart
...
class FormBuilderSearchableDropdown<T> extends FormBuilderField<T> {
  ...
  FormBuilderSearchableDropdown({
    ...
    @Deprecated('Please use [clearButtonProps] instead') this.showClearButton = false,
        ...
        super(
          ...
          builder: (FormFieldState<T?> field) {
            ...
            return DropdownSearch<T>(
              ...
              clearButtonProps: clearButtonProps ?? ClearButtonProps(isVisible: showClearButton),
              compareFn: compareFn,
...
class FormBuilderSearchableDropdownState<T> extends FormBuilderFieldState<FormBuilderSearchableDropdown<T>, T> {}
