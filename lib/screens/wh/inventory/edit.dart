...
class WHInventoryEdit extends EntityHolder {
  const WHInventoryEdit({super.key, required super.entity});

  @override
  State<WHInventoryEdit> createState() => _WHInventoryEditState();
}

class _WHInventoryEditState extends State<WHInventoryEdit> {
  final GlobalKey<FormBuilderState> _formKey = GlobalKey<FormBuilderState>(debugLabel: '_whInventoryEdit');
