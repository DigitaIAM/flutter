...
class PalletDocumentEdit extends EntityHolder {
  const PalletDocumentEdit({super.key, required super.entity});

  @override
  State<StatefulWidget> createState() => _PalletDocumentEditState();
}

class _PalletDocumentEditState extends State<PalletDocumentEdit> {
  final GlobalKey<FormBuilderState> _formKey =
      GlobalKey<FormBuilderState>(debugLabel: '_PalletDocumentEdit');
  ...
  Widget build(BuildContext context) {
    ...
    return ScaffoldView(
      title: localization.translate("pallet"),
      body: Builder(
        builder: (context) {
