...
class KpiReportView extends Entity {
  static const List<String> ctx = ['report', 'kpi'];
  ...
  Widget screen(String action, MemoryItem entity) {
    return EntityScreens(
      ...
      ctx: ctx,
      schema: schema,
      list: ReportScreen(entity: entity),
...
class ReportScreen extends EntityHolder {
  const ReportScreen({super.key, required super.entity});
      ...
      body: SafeArea(
        child: Builder(builder: (context) {
          return Column(children: <Widget>[
            Expanded(
              child: KpiReportScreen(entity: reports[0]),
            ),
          ]);
        }),
      ),
