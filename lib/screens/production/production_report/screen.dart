...
class ProductionReportView extends Entity {
  ...
  Widget screen(String action, MemoryItem entity) {
    return EntityScreens(
      ...
      // TODO remove ProductionOrderView from here, it's a mock
      ...
      builder: (context, state) {
        ...
        switch (state.status) {
          ...
          case RequestStatus.success:
            ...
            return ProductionReportPlutoGrid(stateData: state, loadMore: loadMore);
...
class ProductionReportPlutoGrid extends StatefulWidget {
  const ProductionReportPlutoGrid({Key? key, required this.stateData, required this.loadMore}) : super(key: key);
...
class _ProductionReportPlutoGrid extends State<ProductionReportPlutoGrid> {
  ...
  void initState() {
    ...
    final columnsData = getDataForColumns(widget.stateData.items);
    ...
    rows = intoRows(widget.stateData, null);
  }
  ...
  PlutoGrid buildPlutoGrid(BuildContext context) {
